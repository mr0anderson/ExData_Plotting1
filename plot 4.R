...
plot(as.numeric(household$Time), household$Global_active_power, type = "l", xaxt = 'n',
     ylab = "Global Active Power", xlab = "Thursday\t\tFriday\t\tSaturday")
plot(as.numeric(household$Time), household$Voltage, type = "l", xaxt = 'n',
     ylab = "Voltage", xlab = "Thursday\t\tFriday\t\tSaturday")
...
plot(as.numeric(household$Time), household$Global_reactive_power, type = "l", xaxt = 'n',
     ylab = "Global Reactive Power", xlab = "Thursday\t\tFriday\t\tSaturday")
dev.off()
